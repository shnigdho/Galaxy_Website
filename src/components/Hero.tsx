...
const SLIDES: Slide[] = [
  {
    image: "./public/images/simimage.jpg",
  ...
  {
    image: "./public/images/membershipcard.jpg",
  ...
  {
    image: "./public/images/payment.jpg",
  ...
  {
    image: "./public/images/platform.jpg",
